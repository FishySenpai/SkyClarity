...
const CarsSearch = () => {
  ...
  return (
    <div className="px-6 pt-8 bg-white h-[160px] rounded-md  ">
      <div className="flex flex-row space-x-5   ">
        <div className="relative h-fit ">
          ...
          <input
            className={`h-12 pl-10 w-[295px]  text-gray-800 border rounded px-2 border-gray-400 focus:border-blue-500 bg-white outline-none ${
        ...
        <div className={`relative h-fit ${dropOffCheck ? "" : "hidden"} `}>
          ...
          <input
            className={`h-12 pl-10 w-[295px]  text-gray-800 border rounded px-2 border-gray-400 focus:border-blue-500 bg-white outline-none ${
              dropOffLocation ? "font-semibold text-gray-800" : "font-normal"
            }`}
            type="search"
            placeholder="City, airport or station"
        ...
        <div ref={pickUpPopupRef}>
          ...
          >
            ...
            <input
              className={`h-12 pl-10 w-[150px] border rounded px-2 border-gray-400 border-r-0 focus:border-blue-500 bg-white outline-none cursor-pointer ${
