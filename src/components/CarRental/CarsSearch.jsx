...
const CarsSearch = () => {
  ...
  return (
    <div className="px-6 pt-8 bg-white lg:h-[160px] rounded-md  w-full 1sm:w-[700px] 1md:w-[800px] lg:w-[1000px] 1lg:w-[1100px] xl:w-[1200px] 1xl:w-[1306px] ">
      <div className="flex flex-col lg:flex-row lg:space-x-5   ">
        <div className="flex flex-row space-x-5   w-full">
          ...
          <div
            className={`relative h-fit w-full ${dropOffCheck ? "" : "hidden"} `}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
        ...
        <div className="flex flex-row space-x-5 py-5 lg:py-0 w-full">
