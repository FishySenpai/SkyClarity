...
const CarInfo = () => {
  ...
  return (
    <div className="bg-gray-50">
      ...
      {carsInfo ? (
        <div
          className={`flex flex-col absolute top-[300px] justify-center mx-auto bg-gray-100 ${
            dropOffCheck ? "pt-[310px]" : "pt-[260px]"
          }  2sm:pt-[150px] lg:pt-10 rounded-t-3xl w-full`}
        >
          <div className="text-2xl 2sm:text-3xl pb-5 text-gray-800 font-bold  px-4 w-full 1sm:w-[800px] lg:w-[970px] 2xl:w-[1400px] flex flex-col 2sm:mx-auto 1xl:pl-5">
            <div>Available Cars in Glasgow</div>
          ...
          <div className="flex flex-row justify-center mx-auto rounded-t-3xl w-full">
            ...
            <div
              ...
              } lg:static lg:mx-12 lg:block h-full`}
            >
              <CarFilter
                          ...
                          <div className="flex flex-col space-y-1">
                            ...
                            <div className="text-sm text-gray-600">
                              <span className="font-semibold text-lg ">
                                {carsInfo?.data.quotes[index].new_score.toFixed(
                                  1
                                )}
                              </span>
