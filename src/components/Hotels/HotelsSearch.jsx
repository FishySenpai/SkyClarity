...
const HotelsSearch = ({ home }) => {
  ...
  return (
    <div className={`px-6 py-8 bg-white rounded-md `}>
      <div className="flex flex-col 1lg:flex-row 1lg:space-x-5   ">
        ...
        <div className="pt-6 1sm:space-x-4 flex flex-col 1sm:flex-row 1lg:pt-0 ">
