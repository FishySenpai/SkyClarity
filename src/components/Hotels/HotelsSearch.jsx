    ...
    >
      <div className="flex flex-row space-x-5   ">
        <div className="relative h-fit ">
          ...
          <input
            className={`h-12 pl-10 w-[400px]  text-gray-800 border rounded px-2 border-gray-400 focus:border-blue-500 bg-white outline-none ${
        ...
        <div ref={checkInPopupRef}>
          ...
          >
            ...
            <input
              className={`h-12 pl-10 w-[180px] border rounded px-2 border-gray-400 focus:border-blue-500 bg-white outline-none cursor-pointer ${
        ...
        <div ref={cabinPopupRef} className="relative">
          ...
          >
            ...
            <input
              className="h-12 pl-10 w-[290px] border cursor-pointer text-[16px] pb-1 rounded px-2 text-gray-800 font-semibold border-gray-400 focus:border-blue-500 bg-white outline-none"
              type="search"
