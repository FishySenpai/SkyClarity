...
const fetchLocation = async (location) => {
  ...
  const handleSearch = async () => {
    setIsLoading(true);
    const destination = location; // Replace with actual input value
    const checkIn = checkInDate; // Replace with actual input value
    const checkOut = checkOutDate; // Replace with actual input value

    const destinationId = await fetchLocation(destination);

    if (destinationId) {
      navigate(
        `/hotels/search/${destination}/${destinationId}/${checkIn}/${checkOut}`
      );
    } else {
  ...
  return (
    <div
      className={`px-6 py-8 bg-white rounded-md  flex flex-col 1lg:flex-row space-x-5 `}
    >
      <div className="flex flex-col   ">
        <div className="flex flex-col 1md:flex-row 1md:space-x-5">
          <div className="relative h-fit ">
            ...
            <input
              className={`h-12 pl-10 w-full 1lg:w-[220px] 1xl:w-[400px]  text-gray-800 border rounded px-2 border-gray-400 focus:border-blue-500 bg-white outline-none ${
          ...
          <div className="pt-6 1sm:space-x-4 flex flex-col 1sm:flex-row 1md:pt-0 ">
            <div className="flex space-x-4 w-full">
              <div ref={checkInPopupRef} className="w-full">
                <div
                ...
                >
                  ...
                  <input
                    className={`h-12 pl-10 w-full 1lg:w-[180px] border rounded px-2 border-gray-400 focus:border-blue-500 bg-white outline-none cursor-pointer ${
                      checkInDate
              ...
              <div ref={checkOutPopupRef} className="w-full">
                <div
                  className="relative cursor-pointer h-fit "
                  onClick={() => {
            ...
            <div ref={cabinPopupRef} className="relative mt-4 1sm:mt-0 ">
              <div
                onClick={() => {
              ...
              >
                ...
                <input
                  className="h-12 pl-10 w-full 1sm:w-[290px] border cursor-pointer text-[16px] pb-1 rounded px-2 text-gray-800 font-semibold border-gray-400 focus:border-blue-500 bg-white outline-none"
                  type="search"
              ...
              {cabinDrop ? (
                <div className="flex flex-col text-gray-900 pt-4 z-50 w-[290px] bg-white rounded shadow-md p-2 absolute right-0">
