    ...
    <div>
      ...
      <div className="bg-gray-100 rounded text-gray-500 relative">
        ...
        <div className="absolute top-52 left-[300px]">
          <div className="text-5xl pb-3 text-white font-bold">Find the right Hotel today</div>
          <div className="flex flex-row space-x-5 px-6 py-12  bg-gray-100 h-[180px] rounded-md  ">
