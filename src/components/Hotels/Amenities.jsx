          ...
          },
          {
            ...
            icon: (
              <svg
                ...
                height="1.5rem"
              >
                <path d="M12 2a10 10 0 1 0 10 10A10.03 10.03 0 0 0 12 2m1.5 12H10v2a1 1 0 0 1-2 0V7h5.5a3.5 3.5 0 0 1 0 7m1.5-3.5a1.5 1.5 0 0 1-1.5 1.5H10V9h3.5a1.5 1.5 0 0 1 1.5 1.5"></path>
              </svg>
            ),
          },
          {
            ...
            icon: (
              <svg
                ...
                height="1.5rem"
              >
                <path d="M13 3a1 1 0 0 0-2 0v3.296L8.659 4.247a1 1 0 0 0-1.317 1.506L11 8.953V11H8.954L5.753 7.341a1 1 0 1 0-1.506 1.317L6.297 11H3a1 1 0 0 0 0 2h3.296l-2.049 2.341a1 1 0 1 0 1.506 1.318L8.953 13H11v2.046l-3.659 3.201a1 1 0 1 0 1.317 1.506L11 17.703V21a1 1 0 0 0 2 0v-3.296l2.341 2.049a1 1 0 1 0 1.318-1.506L13 15.047V13h2.046l3.201 3.659a1 1 0 0 0 1.506-1.317L17.703 13H21a1 1 0 0 0 0-2h-3.296l2.049-2.342a1 1 0 0 0-1.506-1.317L15.047 11H13V8.954l3.659-3.201a1 1 0 0 0-1.317-1.506L13 6.297z"></path>
              </svg>
            ),
          },
          {
      ...
      <div className="flex">
        {amenitiesData.map((category) =>
          category.items.map((item) => (
            <div
              key={item.id}
              className="rounded-lg w-[166px] bg-gray-50 ml-2 text-center "
            >
              <span>{item.icon}</span>
